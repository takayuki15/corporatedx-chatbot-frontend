  ...
  const sections = [
    {
      title: '利用にあたって',
      paragraphs: [
        'ムラタヘルプ（以下、本サービス）はムラタ社員向けのヘルプチャットボットサービスです。',
    ...
    },
    {
      title: '個人情報の取り扱い',
      paragraphs: [
        'ムラタヘルプ（以下、本サービス）では、メール等を通じてユーザーニーズに沿ったご提案・ご案内・サポートをするため、またサービス・イベントの改善や向上のため、ユーザの利用履歴情報（プロンプト入力・出力ログやタイトル等）と個人情報等（社内メールアドレス、所属、氏名、ＯＳやブラウザ情報等） を組み合わせ・加工・分析し、社内開発関係者内において利用します。詳しくは、[個人情報の取り扱いについて]をご参照ください。 なお、個人情報の取扱いについて同意いただけない場合は本サービスはご利用頂けません。',
